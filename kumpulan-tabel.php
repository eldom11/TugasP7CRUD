...
<body class="bg-body-secondary">
  ...
  <nav class="navbar bg-body-tertiary mb-5 shadow fixed-top">
    <div class="container">
      ...
      <ul class="nav nav-pills">
        <li class="nav-item">
          <a class="nav-link bg-secondary bg-gradient text-white" href="index.php">KRS</a>
        </li>
        <li class="nav-item">
          <a class="nav-link bg-secondary bg-gradient active ms-2" aria-current="page" href="#">Tabel Basis Data</a>
        </li>
      </ul>
      <!-- AKHIR TAB PILIHAN -->
    </div>
  ...
  <div class="container mb-5 mt-5 pt-4">
    ...
    <a href="kelola-mahasiswa.php" class="btn btn-secondary active" role="button" aria-pressed="true">
  ...
  <div class="container mb-5">
    ...
    <!-- BUTTON TAMBAH DATA MAHASISWA -->
    <a href="kelola-matakuliah.php" class="btn btn-secondary active" role="button" aria-pressed="true">
      <i class="bi bi-plus-square"></i>
      Tambah Data
    </a>
  </div>
  ...
  <div class="container mb-5">
    ...
    <!-- BUTTON TAMBAH DATA MAHASISWA -->
    <a href="kelola-krs.php" class="btn btn-secondary active" role="button" aria-pressed="true">
      <i class="bi bi-plus-square"></i>
      Tambah Data
    </a>
  </div>

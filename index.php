  ...
  <nav class="navbar bg-body-tertiary mb-5 shadow fixed-top">
    <div class="container">
      ...
      <ul class="nav nav-pills">
        <li class="nav-item">
          <a class="nav-link bg-secondary bg-gradient active" aria-current="page" href="#">KRS</a>
        </li>
        <li class="nav-item">
          <a class="nav-link bg-secondary bg-gradient ms-2 text-white" href="kumpulan-tabel.php">Tabel Basis Data</a>
        </li>
        </ul>
        <!-- AKHIR TAB PILIHAN -->
      </div>
